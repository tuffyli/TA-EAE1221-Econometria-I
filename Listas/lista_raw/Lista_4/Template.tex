...
\begingroup  
    \centering
    \LARGE Lista 4 - Econometria I - 2026\\[0.5em]
    %\large \today\\[0.5em]
...
\begin{enumerate}[label=(\alph*)]
    ...
    \item O coeficiente de correlação amostral ente \textit{years} e \textit{rbisyr} é cerca de 0,487. Isso faz sentido?
    \item Qual o fator de inflação de variância (existe só um) dos coeficientes de inclinação da regressão múltipla? Você diria que já colinearidade baixa, moderada ou alta entre \textit{years} e \textit{rbisyr}?

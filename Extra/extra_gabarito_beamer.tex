...
\begin{frame}{Questão 1(iii): variância da média da firma (1/2)}
...
\begin{frame}{Questão 1(iii): variância da média da firma (2/2)}
\step{Continuando a conta do slide anterior:}
...
\begin{frame}{Questão 4(a): comparando colunas (1), (2) e (3)}
\begin{itemize}
...
\begin{frame}{Questão 4(b): efeito de 10\% nos gastos}
...
\begin{frame}{Questão 4(c): termo quadrático}
...
\begin{frame}{Questão 4(d): por que a coluna (2) pode ser melhor que a (3)?}
\begin{itemize}
...
\begin{frame}{Questão 4(e): interação entre gastos e pobreza}
